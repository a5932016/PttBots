...
class Evaluator(Matcher):
    ...
    def __init__(self,segLib="jieba"):
        ...
        self.debugLog = open("chat/data/EvaluateLog.txt",'w',encoding="utf-8")
        ...
        # 中文停用詞與特殊符號加載
        self.loadStopWords(path="chat/data/stopwords/chinese_sw.txt")
        self.loadStopWords(path="chat/data/stopwords/specialMarks.txt")
        self.loadFilterdWord(path="chat/data/stopwords/ptt_words.txt")
