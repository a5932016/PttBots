...
class Matcher(object):
    ...
    def TitlesSegmentation(self, cleanStopwords=False):
        ...
        count = 0
        if not os.path.exists('chat/data/SegTitles.txt'):
            self.segTitles = []
            ...
            with open('chat/data/SegTitles.txt', 'w', encoding="utf-8") as seg_title:
            ...
            with open('chat/data/SegTitles.txt', 'r', encoding="utf-8") as seg_title:
